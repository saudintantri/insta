.class public Lcom/instagram/perf/classpreload/ColdStartClassPreloader;
...
.method public static preloadClasses()V
    ...
    const-class v0, Lsecondary/dex02/Canary;

    const-class v0, Lsecondary/dex03/Canary;

    const-class v0, Lsecondary/dex04/Canary;

    const-class v0, Lsecondary/dex05/Canary;

    const-class v0, Lsecondary/dex06/Canary;

    const-class v0, Lsecondary/dex07/Canary;
    ...
    const-class v0, Lcom/facebook/common/dextricks/DexLibLoader$CanaryLoaderImpl;

    const-class v0, Lcom/facebook/common/dextricks/CanaryLoader;
    ...
    const-class v0, Lcom/instagram/process/instagram/InstagramApplicationForMainProcess;
    ...
    const-class v0, Lcom/facebook/profilo/config/v2/ConfigException;

    const-class v0, LX/022;
    ...
    const-class v0, Lcom/facebook/profilo/config/v2/Config;
    ...
    const-class v0, Landroidx/core/app/ComponentActivity;
    ...
    const-class v0, Lcom/facebook/acra/anr/sigquit/SigquitDetectorLacrima;
    ...
    const-class v0, Lcom/facebook/common/hiddenapis2/ApiExemption;
    ...
    const-class v0, Lcom/facebook/common/artdistract/NativeArtDistract;

    const-class v0, LX/0i5;

    const-class v0, LX/0Ol;

    const-class v0, Lcom/facebook/errorreporting/lacrima/detector/broadcast/SecureShutdownBootBroadcastReceiver;
    ...
    const-class v0, Lcom/facebook/errorreporting/lacrima/detector/broadcast/LockScreenBroadcastReceiver;
    ...
    const-class v0, Lcom/facebook/mobileconfig/MobileConfigDependenciesInFBApps;

    const-class v0, LX/0nQ;

    const-class v0, Lcom/facebook/mobileconfig/MobileConfigDependenciesInWearables;
    ...
    const-class v0, Lcom/facebook/mobileconfig/MobileConfigFetcherHandler;
    ...
    const-class v0, Lcom/instagram/realtime/requeststream/MQTTPublishCallback;

    const-class v0, Lcom/instagram/realtime/requeststream/MQTTRequestStreamClient;

    const-class v0, Lcom/facebook/realtime/requeststream/api/BaseRequestStreamClient;

    const-class v0, LX/0zL;

    const-class v0, Lcom/instagram/model/mediasize/ExtendedImageUrl;

    const-class v0, Lcom/instagram/common/typedurl/ExpirableImageUrl;

    const-class v0, Lcom/instagram/common/typedurl/ImageUrlBase;
    ...
    const-class v0, Lcom/instagram/realtime/requeststream/PulsarScheduler;
    ...
    const-class v0, Lcom/facebook/realtime/requeststream/streamref/NativeStream;
    ...
    const-class v0, Lcom/facebook/pando/TreeUpdaterJNI;
    ...
    const-class v0, Lcom/instagram/api/schemas/FanClubInfoDict;
    ...
    const-class v0, Lcom/instagram/debug/logdelegate/IgLogImpl;
    ...
    const-class v0, Lcom/facebook/mobileconfig/MobileConfigCanaryChangeListener;

    const-class v0, LX/0zv;

    const-class v0, LX/0OE;

    const-class v0, Lcom/instagram/model/mediasize/ProfilePicUrlInfo;
    ...
    const-class v0, Lcom/facebook/quicklog/EventBuilder;
    ...
    const-class v0, Lcom/facebook/traffic/monitor/impl/SimpleTrafficTransportMonitor;

    const-class v0, Lcom/facebook/traffic/monitor/api/ITrafficTransportMonitor;
    ...
    const-class v0, Lcom/facebook/quicklog/reliability/UserFlowLogger;
    ...
    const-class v0, Lcom/facebook/mobileconfig/MobileConfigEmergencyPushChangeListener;
    ...
    const-class v0, Lcom/facebook/mobileconfig/MobileConfigFetcher;

    const-class v0, LX/122;

    const-class v0, Lcom/facebook/mobileconfig/MobileConfigCxxLogger;
    ...
    const-class v0, Lcom/facebook/mobileconfig/MobileConfigUpdateOverridesTableCallback;
    ...
    const-class v0, Lcom/facebook/proxygen/utils/LigerInitializationException;
    ...
    const-class v0, Lcom/instagram/api/tigon/IGTigonQuickPerformanceLogger;

    const-class v0, Lcom/instagram/service/tigon/IGAuthedTigonService;
    ...
    const-class v0, Lcom/facebook/proxygen/SocketData;

    const-class v0, Lcom/facebook/proxygen/ClientTransportMonitor;

    const-class v0, Lcom/facebook/traffic/ctm/api/IClientTransportMonitor;

    const-class v0, Lcom/facebook/proxygen/GoodputEstimate;

    const-class v0, Lcom/facebook/proxygen/GoodputException;

    const-class v0, Lcom/facebook/proxygen/GoodputQueryOptions;

    const-class v0, Lcom/facebook/traffic/ctm/api/ThrottlingUpdateStats$Builder;

    const-class v0, Lcom/facebook/traffic/ctm/api/SocketStateStats$Builder;

    const-class v0, LX/13t;

    const-class v0, Lcom/facebook/traffic/ctm/api/CumulativeConnectionStats$Builder;

    const-class v0, Lcom/facebook/traffic/ctm/api/RsysCallStatus;

    const-class v0, Lcom/facebook/traffic/ctm/api/RsysCallStatus$State;

    const-class v0, LX/13x;

    const-class v0, Lcom/facebook/traffic/ctm/api/RsysThrottlingOptions;

    const-class v0, Lcom/facebook/traffic/ctm/api/RetinaStats;

    const-class v0, LX/140;

    const-class v0, Lcom/facebook/traffic/retina/config/RetinaConfig;
    ...
    const-class v0, Lcom/facebook/voltron/metadata/VoltronModuleMetadataHelper;
    ...
    const-class v0, Lcom/facebook/tigon/tigonligerlite/TigonLigerServiceHolder;
    ...
    const-class v0, Lcom/instagram/api/tigon/TigonServiceLayer;

    const-class v0, LX/15C;

    const-class v0, LX/15D;

    const-class v0, Lcom/facebook/tigon/tigonmns/TigonMNSServiceHolder;
    ...
    const-class v0, Lcom/facebook/stash/core/FileStash;

    const-class v0, Lcom/facebook/stash/core/Stash;
    ...
    const-class v0, Lcom/instagram/sponsored/asyncads/requestpathsignals/signalmanager/signaldata/ParcelableSignalDataDeserializer;
    ...
    const-class v0, Lcom/instagram/model/reels/Reel;
    ...
    const-class v0, Lcom/instagram/mainfeed/network/FeedCacheCoordinator;
    ...
    const-class v0, Lkotlinx/coroutines/test/internal/TestMainDispatcherFactory;
    ...
    const-class v0, Lcom/instagram/mainfeed/network/FeedCacheRoom;

    const-class v0, Lcom/instagram/mainfeed/network/FeedItemDatabase;

    const-class v0, Lcom/instagram/roomdb/IgRoomDatabase;
    ...
    const-class v0, Lcom/instagram/mainfeed/network/FeedItemDatabase_Impl;
    ...
    const-class v0, Lkotlinx/coroutines/DefaultExecutor;
    ...
    const-class v0, Lcom/instagram/common/resources/downloadable/impl/LanguagePackLoader;
    ...
    const-class v0, Lcom/facebook/common/patch/core/BsdiffNativeLibrary;
    ...
    const-class v0, Lcom/facebook/quicklog/PointEditor;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$RealtimeDelegateProvider;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager;

    const-class v0, LX/0x9;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeEventHandlerProvider;

    const-class v0, LX/0at;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$RawSkywalkerSubscriptionsProvider;

    const-class v0, LX/0ap;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$GraphQLSubscriptionsProvider;

    const-class v0, LX/0aq;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$ObserversProvider;

    const-class v0, LX/0bx;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$PresenceMsysAppStateChangeObserverProvider;
    ...
    const-class v0, Lcom/instagram/location/impl/LocationPluginImpl;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/shader/models/ARDWriteThroughShaderAssetProvider;
    ...
    const-class v0, Lcom/instagram/reels/persistence/room/UserReelMediaDatabase_Impl;
    ...
    const-class v0, Lcom/instagram/service/tigon/IGTigonAuthHandler;
    ...
    const-class v0, Lcom/facebook/tigon/iface/TigonAuthHandler;
    ...
    const-class v0, Lcom/facebook/tigon/iface/TigonRequestBuilder$Impl;
    ...
    const-class v0, Lcom/instagram/feed/media/MediaDict__JsonHelper;

    const-class v0, LX/1MF;

    const-class v0, Lcom/instagram/model/fundraiser/FundraiserCampaignTypeEnum;
    ...
    const-class v0, Lcom/instagram/api/schemas/CommentRestrictStatus;
    ...
    const-class v0, Lcom/instagram/tagging/model/TaggableModel;

    const-class v0, LX/1MS;

    const-class v0, LX/1MT;

    const-class v0, Lcom/instagram/analytics/ppr/loggingdata/PPRLoggingData;
    ...
    const-class v0, Lcom/instagram/common/analytics/sampling/BaseAnalytics2SamplingPolicyConfig;
    ...
    const-class v0, Lcom/instagram/analytics/analytics2/IGAnalytics2UploaderBase;
    ...
    const-class v0, Lcom/instagram/base/activity/IgActivity;
    ...
    const-class v0, Lcom/instagram/direct/share/handler/DirectShareHandlerActivity;
    ...
    const-class v0, Lcom/instagram/direct/share/handler/DirectMultipleExternalMediaShareActivity;
    ...
    const-class v0, Lcom/instagram/realtimeclient/bugreport/RealtimeLogsProvider;

    const-class v0, Lcom/instagram/realtimeclient/bugreport/RealtimeLogsProvider$realtimeClientManager$2;
    ...
    const-class v0, Lcom/instagram/debug/image/sessionhelper/ImageDebugSessionHelper;

    const-class v0, Lcom/instagram/debug/image/sessionhelper/ImageDebugSessionHelper$1;
    ...
    const-class v0, Lcom/facebook/graphql/impls/AREffectConsentStateQueryResponsePandoImpl;
    ...
    const-class v0, Lcom/facebook/pando/PandoGraphQLRequest;
    ...
    const-class v0, Lcom/facebook/pando/PandoToken;

    const-class v0, Lcom/facebook/pando/IPandoGraphQLService$Token;

    const-class v0, LX/1Rq;

    const-class v0, Lcom/facebook/pando/PandoGraphQLServiceJNI;

    const-class v0, Lcom/facebook/pando/IPandoGraphQLService;

    const-class v0, Lcom/facebook/pando/PandoRealtimeInfoJNI;
    ...
    const-class v0, Lcom/instagram/fbpay/graphql/FBPayIGGraphQLQueryExecutor;
    ...
    const-class v0, Landroidx/room/RoomDatabaseKt;
    ...
    const-class v0, Lcom/instagram/sponsored/asyncads/pool/persistence/SponsoredPoolItemDatabase_Impl;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/manager/HeroManager;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/HeroPlayerServiceApi;

    const-class v0, Lcom/facebook/video/heroplayer/service/ServiceEventCallbackImpl;

    const-class v0, Lcom/facebook/exoplayer/monitor/VpsEventCallback;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/VideoStartupListener$Stub$Proxy;
    ...
    const-class v0, Lcom/facebook/exoplayer/bandwidthestimator/estimate/VideoBandwidthEstimate;
    ...
    const-class v0, Lcom/instagram/feed/media/ClickToMessagingAdsInfo;
    ...
    const-class v0, Lcom/instagram/model/androidlink/AndroidLink;
    ...
    const-class v0, Lcom/instagram/video/player/hero/IgHeroServiceController$VideoLicenseListenerImpl;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/VideoLicenseListener$Stub;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/VideoLicenseListener;

    const-class v0, LX/1bD;

    const-class v0, LX/1bE;

    const-class v0, Lcom/instagram/realtime/requeststream/dgw/DGWRequestStreamClient;
    ...
    const-class v0, Lcom/instagram/model/reels/ReelHighlightsAttributionType;

    const-class v0, Lcom/instagram/api/schemas/RingSpec;
    ...
    const-class v0, Lcom/facebook/realtime/common/appstate/AppStateGetter;

    const-class v0, LX/1bZ;

    const-class v0, Lcom/facebook/realtime/requeststream/client/SandboxConfigSource;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$1;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$3;

    const-class v0, LX/1bd;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$4;

    const-class v0, LX/1bf;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$5;

    const-class v0, LX/1bh;

    const-class v0, LX/1bi;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$Observer;
    ...
    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconSubscribeExecutorTrigger;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconSubscribeExecutorTrigger$1;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/FleetBeaconEvent;

    const-class v0, LX/09l;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/IGRealtimeGraphQLObserverHolder$2;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/DistillerySubscribeExecutor;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/SubscribeExecutor;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/DistillerySubscribeExecutor$1;

    const-class v0, Lcom/instagram/realtime/requeststream/TransportSelectingRequestStreamClient;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/SubscribeExecutor$1;
    ...
    const-class v0, Lcom/instagram/realtimeclient/requeststream/IGGraphQLSubscriptionRequestStringStub;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeEvent__JsonHelper;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/GraphQLSubscriptionRequestStub;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/GraphQLSubscriptionRequestStub$SimpleGraphqlQueryParameters;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/IGRealtimeGraphQLObserverHolder$3;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/DataCallBack;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/SubscriptionHandler;

    const-class v0, LX/1cX;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/SubscribeExecutor$2;

    const-class v0, Lcom/facebook/realtime/requeststream/streameventhandler/StreamEventHandler;
    ...
    const-class v0, Lcom/instagram/creation/persistence/CreationDatabase_Impl;
    ...
    const-class v0, Lcom/instagram/igtv/persistence/IGTVDatabase;

    const-class v0, LX/1cn;

    const-class v0, Lcom/instagram/igtv/persistence/IGTVDatabase_Impl;

    const-class v0, LX/1cp;

    const-class v0, Lcom/instagram/clips/drafts/model/migrations/FeedVideoClipsDraftMigration;

    const-class v0, LX/1cr;

    const-class v0, Lcom/instagram/clips/drafts/model/migrations/ClipsDraftInfoMigration;

    const-class v0, Lcom/instagram/clips/drafts/model/disk/PanaVideoSourceVideoDiskCleanupJob;

    const-class v0, LX/1cu;

    const-class v0, Lcom/instagram/clips/drafts/model/disk/DraftDirectoryDiskCleanupJob;
    ...
    const-class v0, Lcom/instagram/reels/draft/model/migrations/StoryDraftMigration;

    const-class v0, Lcom/instagram/reels/draft/migrators/StoryDraftMigrator;
    ...
    const-class v0, Lcom/instagram/clips/drafts/model/datasource/ClipsDraftLocalDataSource;
    ...
    const-class v0, Lcom/instagram/debug/quickexperiment/dumper/QuickExperimentDumperPlugin$UserSessionListener;

    const-class v0, Lcom/instagram/debug/quickexperiment/dumper/QuickExperimentDumperPlugin$UserSessionListener$1;

    const-class v0, Lcom/instagram/debug/quickexperiment/dumper/QuickExperimentDumperPlugin;
    ...
    const-class v0, Lcom/facebook/msys/mci/Analytics;

    const-class v0, Lcom/facebook/msys/mci/Proxies;

    const-class v0, Lcom/facebook/msys/mci/AppContainerDirectoryPath;

    const-class v0, Lcom/facebook/msys/mci/AppInfo;

    const-class v0, Lcom/facebook/msys/mci/AppState;

    const-class v0, Lcom/facebook/msys/mci/Attachment;

    const-class v0, Lcom/facebook/msys/mci/AuthData;

    const-class v0, Lcom/facebook/msys/mci/AuthDataStorage;

    const-class v0, Lcom/facebook/msys/mci/AuthSession;

    const-class v0, Lcom/facebook/msys/mci/BinarySerialization;

    const-class v0, Lcom/facebook/msys/mci/Connectivity;

    const-class v0, Lcom/facebook/msys/util/Environment;

    const-class v0, Lcom/facebook/msys/mci/Execution;

    const-class v0, Lcom/facebook/msys/mci/FileManager;

    const-class v0, Lcom/facebook/msys/mci/JsonSerialization;

    const-class v0, Lcom/facebook/msys/mci/Localization;

    const-class v0, Lcom/facebook/msys/mci/Log;

    const-class v0, Lcom/facebook/msys/mci/LoggingOption;

    const-class v0, Lcom/facebook/msys/mci/MediaSendConfig;

    const-class v0, Lcom/facebook/msys/mci/MediaSendContentInfo;

    const-class v0, Lcom/facebook/msys/mcf/MsysError;

    const-class v0, Lcom/facebook/msys/util/NativeRunnable;

    const-class v0, Lcom/facebook/msys/mci/NetworkMultiPartParam;

    const-class v0, Lcom/facebook/msys/mci/NetworkSession;

    const-class v0, Lcom/facebook/msys/mci/NetworkUtils;

    const-class v0, Lcom/facebook/msys/mci/NotificationCenter;

    const-class v0, Lcom/facebook/msys/mci/RedactedString;

    const-class v0, Lcom/facebook/msys/mci/Stats;

    const-class v0, Lcom/facebook/msys/mci/TaskTracker;

    const-class v0, Lcom/facebook/msys/mci/TraceInfo;

    const-class v0, Lcom/facebook/msys/mci/TranscodeVideoCompletionCallback;

    const-class v0, Lcom/facebook/msys/mci/TranscodeGifCompletionCallback;

    const-class v0, Lcom/facebook/msys/mci/UrlRequest;

    const-class v0, Lcom/facebook/msys/mci/UrlResponse;

    const-class v0, Lcom/facebook/msys/mci/VideoEdits;

    const-class v0, Lcom/facebook/msys/mci/VideoSizeEstimatorCompletionCallback;

    const-class v0, Lcom/facebook/msys/mci/PrivacyContext;

    const-class v0, Lcom/facebook/msys/mci/TransportAgnosticLogging;

    const-class v0, Lcom/facebook/msys/mci/EventLoggingData;

    const-class v0, Lcom/facebook/msys/mci/PrivacyContextSubscriberRouting;

    const-class v0, Lcom/facebook/msys/mci/TraceLogger;

    const-class v0, Lcom/facebook/msys/mci/PersistedMsysLogFileCollector;

    const-class v0, Lcom/facebook/simplejni/CoreFunctions;
    ...
    const-class v0, Lcom/instagram/quickpromotion/sdk/InstagramQpSdkModule;
    ...
    const-class v0, Lcom/instagram/pendingmedia/model/PendingMedia;
    ...
    const-class v0, Lcom/instagram/mainactivity/LauncherActivity;

    const-class v0, LX/00E;

    const-class v0, Landroidx/activity/ComponentActivity$3;
    ...
    const-class v0, Landroidx/activity/ComponentActivity$4;

    const-class v0, Landroidx/activity/ComponentActivity$5;
    ...
    const-class v0, LX/03A;

    const-class v0, LX/03F;
    ...
    const-class v0, Landroidx/savedstate/SavedStateRegistry$1;

    const-class v0, Landroidx/activity/OnBackPressedDispatcher$LifecycleOnBackPressedCancellable;
    ...
    const-class v0, Lcom/instagram/service/tigon/IGAuthedTigonService$HeaderProvider;
    ...
    const-class v0, Lcom/instagram/api/schemas/AvatarStatus;
    ...
    const-class v0, Lcom/instagram/model/shopping/merchant/CreatorShoppingInfo;
    ...
    const-class v0, Lcom/instagram/api/schemas/FanClubStatusSyncInfo;
    ...
    const-class v0, Lcom/facebook/graphql/impls/AREffectConsentStateQueryResponsePandoImpl$Viewer;
    ...
    const-class v0, Lcom/instagram/api/schemas/GrowthFrictionInfo;

    const-class v0, Lcom/facebook/common/classmarkers/ColdStartClassPreloadingMarkerStart;

    const-class v0, LX/1nK;

    const-class v0, Lcom/instagram/ui/windowinsets/WindowInsetsManager$1;
    ...
    const-class v0, Landroidx/lifecycle/CoroutineLiveData;

    const-class v0, LX/1nn;

    const-class v0, LX/1no;

    const-class v0, Lcom/instagram/mainactivity/bouncebacktoast/ui/BounceBackToast;

    const-class v0, LX/1nq;

    const-class v0, LX/1nr;

    const-class v0, Lcom/instagram/common/kotlindelegate/lifecycle/LazyAutoCleanup;

    const-class v0, Lcom/instagram/common/kotlindelegate/lifecycle/AutoCleanup;

    const-class v0, Lcom/instagram/common/kotlindelegate/lifecycle/AutoCleanup$Observer;

    const-class v0, Landroidx/lifecycle/OnLifecycleEvent;

    const-class v0, Landroidx/lifecycle/ReflectiveGenericLifecycleObserver;
    ...
    const-class v0, Lcom/instagram/api/schemas/ClipsBreakingCreatorInfo;
    ...
    const-class v0, Lcom/instagram/ui/swipenavigation/SwipeNavigationContainer;

    const-class v0, LX/028;

    const-class v0, LX/1oG;

    const-class v0, Lcom/instagram/common/ui/widget/touchinterceptorlayout/TouchInterceptorCoordinatorLayout;

    const-class v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;

    const-class v0, LX/1oJ;

    const-class v0, Lcom/instagram/common/ui/widget/touchinterceptorlayout/TouchInterceptorLinearLayout;

    const-class v0, Lcom/instagram/common/ui/widget/touchinterceptorlayout/TouchInterceptorFrameLayout;
    ...
    const-class v0, Lcom/instagram/model/mediasize/AdditionalCandidates;

    const-class v0, LX/1of;

    const-class v0, LX/1og;

    const-class v0, Lcom/instagram/feed/media/CropCoordinates;

    const-class v0, LX/1oi;

    const-class v0, LX/1oj;

    const-class v0, Lcom/instagram/common/ui/base/IgTextView;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/component/BaseBadgeView$onResumeLifecycleObserver$1;

    const-class v0, LX/1pp;

    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$shouldShowBadge$2;
    ...
    const-class v0, Landroidx/lifecycle/LiveData$LifecycleBoundObserver;
    ...
    const-class v0, Lcom/facebook/litho/widget/LithoScrollView;
    ...
    const-class v0, Landroidx/fragment/app/CustomFragment$1;

    const-class v0, Landroidx/fragment/app/Fragment$5;
    ...
    const-class v0, Lcom/instagram/user/follow/FollowButton;

    const-class v0, Lcom/instagram/user/follow/FollowButtonBase;

    const-class v0, Lcom/instagram/ui/widget/textview/UpdatableButton;

    const-class v0, Lcom/instagram/ui/widget/textview/ImageWithTitleTextView;

    const-class v0, Lcom/instagram/common/ui/text/TitleTextView;
    ...
    const-class v0, Lcom/instagram/ui/widget/roundedcornerlayout/RoundedCornerFrameLayout;
    ...
    const-class v0, Lcom/instagram/graphql/instagramschema/BasicAdsOptInQueryResponsePandoImpl;

    const-class v0, LX/1tG;

    const-class v0, Lcom/facebook/graphql/query/JSONPersistedQueryProvider;
    ...
    const-class v0, Lcom/instagram/quickpromotion/intf/QuickPromotionSlot;
    ...
    const-class v0, Lcom/instagram/mainfeed/unconnectedcontent/GroupSetBinderGroup;
    ...
    const-class v0, LX/260;

    const-class v0, LX/261;

    const-class v0, LX/262;

    const-class v0, LX/263;

    const-class v0, LX/264;

    const-class v0, LX/265;

    const-class v0, LX/266;

    const-class v0, LX/267;
    ...
    const-class v0, LX/271;

    const-class v0, LX/272;

    const-class v0, LX/273;

    const-class v0, LX/274;
    ...
    const-class v0, Lcom/instagram/ui/widget/refresh/RefreshableNestedScrollingParent;
    ...
    const-class v0, Lcom/instagram/common/ui/widget/recyclerview/MainFeedRecyclerView;
    ...
    const-class v0, Lcom/instagram/comments/controller/CommentComposerController;

    const-class v0, LX/28X;

    const-class v0, LX/28Y;

    const-class v0, Lcom/instagram/comments/controller/SimpleCommentComposerController;
    ...
    const-class v0, Lcom/facebook/analytics2/logger/PrivacyControlledUploader;
    ...
    const-class v0, Lcom/instagram/mainfeed/fragment/MainFeedLinearLayoutManager;

    const-class v0, Lcom/instagram/common/ui/widget/recyclerview/FastScrollingLinearLayoutManager;

    const-class v0, Lcom/instagram/common/ui/widget/recyclerview/CustomScrollingLinearLayoutManager;

    const-class v0, Lcom/instagram/common/ui/widget/recyclerview/LinearLayoutManagerCompat;
    ...
    const-class v0, Lcom/instagram/ui/widget/refresh/RefreshableListView;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$filterCombine$2$2;
    ...
    const-class v0, LX/2B6;

    const-class v0, LX/2B7;

    const-class v0, LX/2B8;

    const-class v0, LX/2B9;
    ...
    const-class v0, Lcom/facebook/tigon/TigonError;
    ...
    const-class v0, Landroidx/lifecycle/RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1;
    ...
    const-class v0, Lcom/instagram/api/schemas/RingSpecPoint;
    ...
    const-class v0, Lcom/instagram/model/mediasize/SpritesheetInfo;
    ...
    const-class v0, Lcom/instagram/graphql/instagramschema/BasicAdsOptInQueryResponsePandoImpl$XfbUserBasicAdsPreferences;
    ...
    const-class v0, Lcom/facebook/msys/mci/DataTaskListener;
    ...
    const-class v0, Lcom/facebook/msys/util/Provider;
    ...
    const-class v0, Lcom/facebook/msys/mci/ProxyProvider;
    ...
    const-class v0, Lcom/facebook/msys/mci/Database$OpenCallback;
    ...
    const-class v0, Lcom/facebook/messenger/mcp/integration/MCPPluginsRegistryIntegration;
    ...
    const-class v0, Lcom/facebook/msys/mci/DatabaseHealthMonitor$FatalErrorCallback;

    const-class v0, LX/2G4;

    const-class v0, Lcom/facebook/msys/mca/MailboxCallback;
    ...
    const-class v0, Lcom/facebook/msys/mcd/MqttNetworkSessionPlugin;
    ...
    const-class v0, Lcom/facebook/msys/mdm/DatabaseExtensionsRegister;

    const-class v0, LX/2GP;

    const-class v0, Lcom/facebook/msys/mcd/DatabaseOpenCallback;

    const-class v0, LX/2GR;

    const-class v0, LX/2GS;

    const-class v0, Lcom/facebook/msys/mca/Mailbox;

    const-class v0, Lcom/facebook/msys/mca/MailboxExperimentCache;

    const-class v0, Lcom/facebook/msys/mcd/MediaSendManager;

    const-class v0, Lcom/facebook/msys/mcd/MediaTranscodeConfig;

    const-class v0, Lcom/facebook/msys/mcd/MediaUploadConfig;

    const-class v0, Lcom/facebook/msys/mcd/MediaUploadContentSource;

    const-class v0, Lcom/facebook/msys/mcd/MediaUploadJobDetail;

    const-class v0, Lcom/facebook/msys/mcs/Messaging;

    const-class v0, Lcom/facebook/msys/mca/NativeMailboxCallback;

    const-class v0, Lcom/facebook/msys/util/NotificationScope;

    const-class v0, LX/2Gd;

    const-class v0, LX/2Ge;

    const-class v0, Lcom/facebook/msys/mcs/Presence;

    const-class v0, Lcom/facebook/msys/mca/SlimMailbox;

    const-class v0, Lcom/facebook/msys/mcs/SyncHandler;

    const-class v0, Lcom/facebook/msys/mca/System;

    const-class v0, Lcom/facebook/msys/mca/ThreadIdentifier;

    const-class v0, Lcom/facebook/msys/mca/Vault;
    ...
    const-class v0, LX/2H2;

    const-class v0, LX/2H3;

    const-class v0, LX/2H4;

    const-class v0, Lcom/facebook/msys/mca/Mailbox$DatabaseCallback;

    const-class v0, LX/2H6;

    const-class v0, LX/2H7;

    const-class v0, Lcom/facebook/quicklog/reliability/UserFlowConfig;
    ...
    const-class v0, Lcom/facebook/msys/dasm/DasmSupportHelper;

    const-class v0, Lcom/facebook/msys/config/infranosqlite/MsysInfraNoSqliteObjectHolder;

    const-class v0, LX/2HE;

    const-class v0, Lcom/facebook/msys/mci/SqlUtils;

    const-class v0, LX/2HG;

    const-class v0, Lcom/facebook/msys/mci/AuthDataContext;

    const-class v0, Lcom/facebook/msys/mci/CQLResultSetImpl;

    const-class v0, Lcom/facebook/msys/mci/CQLResultSet;

    const-class v0, Lcom/facebook/msys/mci/Database;

    const-class v0, Lcom/facebook/msys/mci/DatabaseConnection;

    const-class v0, Lcom/facebook/msys/mci/DatabaseConnectionSettings;

    const-class v0, Lcom/facebook/msys/mci/DatabaseHealthMonitor;

    const-class v0, Lcom/facebook/msys/mci/DatabaseFileManager;

    const-class v0, Lcom/facebook/msys/mci/DatabaseMonitor;

    const-class v0, Lcom/facebook/msys/mci/DatabaseUtils;

    const-class v0, Lcom/facebook/msys/mci/PrivacyContextCoding;

    const-class v0, Lcom/facebook/msys/mci/SqlStatementCache;
    ...
    const-class v0, Lcom/facebook/msys/mci/Settings;

    const-class v0, Lcom/facebook/instagram/msys/InstagramTableToProcedureNameMapRegisterer;

    const-class v0, Lcom/google/android/gms/common/zzi;

    const-class v0, Lcom/google/android/gms/common/internal/zzy;

    const-class v0, Lcom/google/android/gms/common/internal/zzz;

    const-class v0, Lcom/google/android/gms/common/zze;

    const-class v0, Lcom/google/android/gms/common/zzk;
    ...
    const-class v0, Lcom/google/android/gms/common/zzj;

    const-class v0, LX/2Hr;

    const-class v0, Lcom/google/android/gms/dynamic/ObjectWrapper;

    const-class v0, Lcom/google/android/gms/dynamic/IObjectWrapper$Stub;

    const-class v0, Lcom/google/android/gms/dynamic/IObjectWrapper;
    ...
    const-class v0, Lcom/facebook/instagram/msys/InstagramDasmConfigCreator;

    const-class v0, Lcom/facebook/msys/mcs/DasmConfigCreator;
    ...
    const-class v0, Lcom/facebook/msys/mci/Database$SchemaDeployer;

    const-class v0, LX/2I5;

    const-class v0, Lcom/facebook/msys/mci/NotificationCenter$NotificationCallback;
    ...
    const-class v0, Lcom/facebook/msys/mci/DefaultUUID;

    const-class v0, Lcom/facebook/msys/mci/UUID;
    ...
    const-class v0, LX/03O;

    const-class v0, LX/06d;

    const-class v0, Lcom/facebook/rti/push/service/FbnsServiceDelegate;

    const-class v0, Lcom/facebook/rti/mqtt/manager/MqttPushServiceDelegate;

    const-class v0, Lcom/facebook/rti/mqtt/manager/MqttBackgroundServiceDelegate;
    ...
    const-class v0, Lcom/facebook/msys/mci/SqliteHolder;

    const-class v0, Lcom/facebook/instagram/msys/InstagramDatabaseSchemaDeployer;
    ...
    const-class v0, Lcom/facebook/core/mca/MailboxCoreJNI;
    ...
    const-class v0, Lcom/facebook/experiment/mca/MailboxExperimentJNI;

    const-class v0, Lcom/facebook/messenger/sync/taskexecutormanager/TaskExecutorManagerRegistererImpl;
    ...
    const-class v0, Lcom/instagram/direct/msys/armadillo/IGSecureMessageCryptoProvider;

    const-class v0, LX/2JC;

    const-class v0, Lcom/facebook/advancedcryptotransport/LigerStreamEventBaseThread;

    const-class v0, Lcom/facebook/advancedcryptotransport/MNSStreamThread;

    const-class v0, Lcom/facebook/advancedcryptotransport/DnsResolverImpl;

    const-class v0, LX/2JG;

    const-class v0, Lcom/instagram/direct/msys/armadillo/IGSecureMessageMasterKeyProvider;

    const-class v0, LX/2JI;

    const-class v0, Lcom/facebook/djinni/msys/infra/McfReference;

    const-class v0, Lcom/facebook/rsys/cryptocontextfactory/gen/CryptoContextFactory$CProxy;

    const-class v0, Lcom/facebook/rsys/cryptocontextfactory/gen/CryptoContextFactory;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$Publish;
    ...
    const-class v0, Lcom/facebook/msys/mci/DataTask;
    ...
    const-class v0, Lcom/facebook/msys/mci/JobScheduler;
    ...
    const-class v0, LX/2KN;

    const-class v0, LX/2KO;

    const-class v0, LX/2KP;
    ...
    const-class v0, Lcom/instagram/clips/drafts/model/migrations/util/ClipsDraftsMigrationUtil;
    ...
    const-class v0, Lcom/instagram/ui/recyclerpager/HorizontalRecyclerPager;

    const-class v0, LX/2LQ;

    const-class v0, Lcom/instagram/ui/layoutmanager/BetterLinearLayoutManager;

    const-class v0, Landroidx/recyclerview/widget/AutoMeasureLinearLayoutManager;

    const-class v0, LX/2LT;

    const-class v0, LX/2LU;

    const-class v0, LX/0UD;

    const-class v0, LX/0vf;

    const-class v0, Lcom/instagram/realtimeclient/clientconfig/L$qe_ig_android_realtime_mqtt_logging$log_sample_rate;

    const-class v0, Lcom/instagram/realtimeclient/clientconfig/L$qe_ig_android_realtime_mqtt_logging$is_enabled;

    const-class v0, Lcom/instagram/realtimeclient/clientconfig/L$ig_android_realtime_subscription_log$is_enabled;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RealtimeMqttClientConfig$1;

    const-class v0, LX/2Lc;

    const-class v0, Lcom/instagram/realtimeclient/MainRealtimeEventHandler$Delegate;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$IgnoredMqttTopicsHandler;
    ...
    const-class v0, Lcom/instagram/realtimeclient/ZeroProvisionRealtimeService;

    const-class v0, Lcom/instagram/realtimeclient/ZeroProvisionRealtimeService$1;
    ...
    const-class v0, Lcom/instagram/realtimeclient/InAppNotificationRealtimeEventHandler;

    const-class v0, LX/2M2;

    const-class v0, LX/2M3;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconRealtimeReceivePublishEventHandler;
    ...
    const-class v0, Lcom/instagram/direct/inbox/notes/NotesApi;

    const-class v0, Lcom/instagram/reels/ui/badge/ReelBrandingBadgeView;
    ...
    const-class v0, Lcom/instagram/realtimeclient/PresenceSubscriptionIDStore;

    const-class v0, Lcom/instagram/realtimeclient/PresenceSubscriptionIDStore$1;

    const-class v0, LX/2Mv;

    const-class v0, LX/2Mw;

    const-class v0, Lcom/instagram/realtimeclient/L$ig_android_mqtt_unified_client_logging$enabled;

    const-class v0, LX/2My;

    const-class v0, Lcom/instagram/realtimeclient/ThriftPayloadEncoder;
    ...
    const-class v0, Lcom/instagram/realtimeclient/L$qe_ig_rti_inapp_notifications_universe$is_enabled;

    const-class v0, Lcom/instagram/realtimeclient/L$ig_android_reels_together$is_enabled;

    const-class v0, Lcom/instagram/hashtag/ui/HashtagFollowButton;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RawSkywalkerSubscription;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconTestTrigger;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconTestTrigger$1;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconTestTrigger$2;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconDeepAckEvent;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconTestTrigger$3;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconPublishReceivedEvent;

    const-class v0, LX/0by;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$PresenceMsysAppStateChangeObserver;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$8;
    ...
    const-class v0, Lcom/instagram/common/ui/widget/zoomcontainer/SimpleZoomableViewContainer;

    const-class v0, Lcom/instagram/ui/widget/framelayout/MediaFrameLayout;
    ...
    const-class v0, Lcom/instagram/ui/mediaactions/LikeActionView;

    const-class v0, LX/2Od;

    const-class v0, Lcom/instagram/ui/mediaactions/MediaActionsView;
    ...
    const-class v0, Lcom/instagram/ui/widget/slideouticon/SlideInAndOutIconView;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/common/MosScoreCalculation;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/PrefetchTaskQueueStartEvent;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/PrefetchTaskQueueExitEvent;
    ...
    const-class v0, Lcom/facebook/exoplayer/datasource/FbHttpProxyDataSource;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/PrefetchTaskQueueCompleteEvent;
    ...
    const-class v0, Lcom/instagram/tagging/api/model/MediaSuggestedProductTag;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$10;
    ...
    const-class v0, Lcom/instagram/shopping/model/destination/home/ShoppingHomeFeedEndpoint$MainFeedEndpoint;

    const-class v0, Lcom/instagram/shopping/model/destination/home/ShoppingHomeFeedEndpoint;
    ...
    const-class v0, Lcom/instagram/ui/widget/loadmore/LoadMoreButton;
    ...
    const-class v0, Lcom/instagram/model/shopping/ShoppingHomeDestination;
    ...
    const-class v0, Lcom/instagram/api/schemas/CheckoutStyle;

    const-class v0, Lcom/instagram/api/schemas/ProductAffiliateInformationDict;

    const-class v0, Lcom/instagram/api/schemas/ProductArtsLabelsDict;

    const-class v0, Lcom/instagram/model/shopping/ProductCheckoutProperties;

    const-class v0, Lcom/instagram/api/schemas/CommerceDrawingDict;

    const-class v0, Lcom/instagram/api/schemas/CommerceReviewStatisticsDict;

    const-class v0, Lcom/instagram/api/schemas/ProductDiscountsDict;

    const-class v0, Lcom/instagram/model/shopping/ProductLaunchInformation;

    const-class v0, Lcom/instagram/api/schemas/LoyaltyToplineInfoDict;

    const-class v0, Lcom/instagram/api/schemas/ProductReviewStatus;

    const-class v0, LX/2UN;

    const-class v0, Lcom/instagram/api/schemas/SellerBadgeDict;
    ...
    const-class v0, Lcom/instagram/ui/widget/pageindicator/CirclePageIndicator;
    ...
    const-class v0, Lcom/instagram/shopping/model/destination/home/FilterDisplayType;
    ...
    const-class v0, Lcom/instagram/api/schemas/FanClubFanConsiderationPageFeatureEligibilityResponse;

    const-class v0, Lcom/facebook/common/classmarkers/IsColdStartRun;
    ...
    const-class v0, Lcom/facebook/profilo/logger/MultiBufferLogger;

    const-class v0, LX/2W4;

    const-class v0, Lcom/facebook/analytics/memory/AddressSpace;
    ...
    const-class v0, Lcom/facebook/profilo/provider/class_load/ClassLoadProvider;
    ...
    const-class v0, Lcom/facebook/profilo/provider/memorymappings/MemoryMappingActionsProvider;

    const-class v0, Lcom/facebook/profilo/provider/nativememory/NativeMemoryAllocationProvider;
    ...
    const-class v0, Lcom/facebook/fixie/fixes/render/RenderThreadANRFixer;
    ...
    const-class v0, LX/2WQ;

    const-class v0, LX/2WR;
    ...
    const-class v0, Lcom/google/common/collect/MapMakerInternalMap$Strength$1;

    const-class v0, Lcom/google/common/collect/MapMakerInternalMap$Strength$2;
    ...
    const-class v0, Lcom/instagram/debug/devoptions/debughead/data/provider/DebugHeadQplListener;
    ...
    const-class v0, Lcom/facebook/mobileconfig/MobileConfigUsingPureJavaDependencies;
    ...
    const-class v0, Lcom/instagram/util/startup/tracking/AppStartupTracker$State$1;
    ...
    const-class v0, Lcom/facebook/traffic/knob/InbandTelemetryBweEstimate$Builder;
    ...
    const-class v0, Lcom/facebook/cameracore/ardelivery/shader/models/DeviceKey;
    ...
    const-class v0, Lcom/instagram/mainfeed/network/FlashFeedCache;
    ...
    const-class v0, Lcom/instagram/wellbeing/respectfulcommentnudge/impl/RespectfulNudgePluginImpl;

    const-class v0, Lcom/instagram/wellbeing/respectfulcommentnudge/data/RepositoryImpl;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RealtimeEventHandler;
    ...
    const-class v0, Lcom/instagram/api/schemas/ClientDisplayMethod;

    const-class v0, Lcom/instagram/model/mediasize/SpriteSheetInfoCandidates;
    ...
    const-class v0, Lcom/instagram/feed/media/AdModelType;
    ...
    const-class v0, Lcom/instagram/model/mediatype/CTAStyle;
    ...
    const-class v0, Lcom/google/common/collect/EvictingQueue;

    const-class v0, LX/2av;

    const-class v0, LX/2aw;

    const-class v0, Lcom/google/common/collect/Synchronized$SynchronizedQueue;
    ...
    const-class v0, Lcom/instagram/debug/image/ImageDebugConfiguration;
    ...
    const-class v0, Lcom/instagram/debug/network/DebugNetworkShapingConfigurationFactory$1;

    const-class v0, Lcom/instagram/debug/network/NetworkShapingConfiguration;

    const-class v0, Lcom/instagram/common/ui/widget/imageview/IgImageView;
    ...
    const-class v0, Lcom/facebook/graphservice/nativeconfigloader/GraphServiceNativeConfigLoader;

    const-class v0, Lcom/facebook/graphservice/asset/GraphServiceAsset$GraphQLServiceConfig;
    ...
    const-class v0, Lcom/instagram/monetization/api/MonetizationApi;
    ...
    const-class v0, Lcom/instagram/notifications/badging/impl/BadgingApiImpl;
    ...
    const-class v0, Lcom/instagram/service/tigon/IGTigonService;

    const-class v0, Lcom/facebook/tigon/TigonXplatService;

    const-class v0, Lcom/instagram/service/tigon/IGTigonConfig;

    const-class v0, LX/2cL;

    const-class v0, Lcom/instagram/service/tigon/TigonUnexpectedErrorReporter;

    const-class v0, LX/2cN;

    const-class v0, Lcom/instagram/graphservice/service/pando/regionhint/IG4ARegionHintHelper;

    const-class v0, Lcom/instagram/realtime/requeststream/MQTTProtocol;

    const-class v0, Lcom/facebook/realtime/common/streamid/RSStreamIdProvider;

    const-class v0, Lcom/instagram/realtimeclient/MainRealtimeEventHandler;

    const-class v0, Lcom/instagram/realtimeclient/DirectRealtimeEventHandler;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$2;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$6;

    const-class v0, LX/2cV;

    const-class v0, Lcom/facebook/video/heroplayer/setting/HeroPlayerSetting;

    const-class v0, LX/2cX;

    const-class v0, Lcom/facebook/realtime/common/appstate/AppStateSyncer;

    const-class v0, LX/2cZ;

    const-class v0, Lcom/instagram/graphql/rtgql/graphqllivequeries/sdk/IGGraphQLLiveQuerySDKProvider;

    const-class v0, Lcom/facebook/graphql/rtgql/graphqllivequeriessdk/base/GraphQLLiveQueriesSDKProviderBase;

    const-class v0, Lcom/facebook/graphql/rtgql/sdk/lite/RealtimeGraphQLSDKProvider;

    const-class v0, Lcom/facebook/graphql/rtgql/sdk/base/RealtimeGraphQLSDKProviderBase;

    const-class v0, Lcom/facebook/realtime/config/RealtimeConfigSourceProxy;

    const-class v0, Lcom/instagram/graphservice/service/pando/IGPandoGraphQLPrimaryExecutionJNI;

    const-class v0, Lcom/facebook/pando/PandoPrimaryExecution;

    const-class v0, LX/2ch;

    const-class v0, Lcom/facebook/pando/IPandoGraphQLService$Result;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/DynamicPlayerSettings;
    ...
    const-class v0, Lcom/facebook/http/historical/NetworkInfoMap;

    const-class v0, Lcom/facebook/video/heroplayer/service/live/impl/HeroDashLiveManagerImpl;
    ...
    const-class v0, Lcom/facebook/exoplayer/formatevaluator/configuration/AbrContextAwareConfiguration;

    const-class v0, Lcom/facebook/traffic/knob/InbandTelemetryBweEstimate;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/common/GlobalPlayerStateMonitor;
    ...
    const-class v0, Lcom/instagram/distribgw/client/DGWClient;

    const-class v0, Lcom/facebook/distribgw/client/ConnectivityManagerOptions;

    const-class v0, Lcom/facebook/distribgw/client/RequestResponseManagerOptions;

    const-class v0, Lcom/facebook/distribgw/client/mns/MNSDGWNetworkStackConfig;

    const-class v0, Lcom/facebook/distribgw/client/mns/MNSDGWNetworkStackWrapperHolder;

    const-class v0, Lcom/facebook/distribgw/client/DGWNetworkStackWrapperHolder;

    const-class v0, LX/2dh;

    const-class v0, Lcom/facebook/mobilenetwork/internal/certificateverifier/CertificateVerifier;

    const-class v0, LX/2dj;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/IGRealtimeGraphQLObserverHolder;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/IGRealtimeGraphQLObserverHolder$DistilleryIGRealtimeGraphQLObserverHolder;
    ...
    const-class v0, Lcom/google/android/exoplayer2/util/Util;
    ...
    const-class v0, Lcom/instagram/clips/drafts/model/ClipsDraftPreviewItemRepository;
    ...
    const-class v0, Lcom/facebook/android/maps/StaticMapView$StaticMapOptions;

    const-class v0, LX/2eH;

    const-class v0, Lcom/facebook/simplejni/NativeHolder;

    const-class v0, LX/2eJ;

    const-class v0, Lcom/facebook/simplejni/NativeHolder$Destructor;
    ...
    const-class v0, Lcom/instagram/api/schemas/HasOnboardedCreatorMonetizationProduct;
    ...
    const-class v0, Lcom/facebook/common/fury/IgFury;
    ...
    const-class v0, Lcom/instagram/api/schemas/MusicCanonicalType;

    const-class v0, Lcom/instagram/api/schemas/ClipsCreationEntryPoint;
    ...
    const-class v0, Lcom/instagram/clips/model/metadata/ClipsContextualHighlightInfo;
    ...
    const-class v0, Lcom/facebook/quicklog/JNIMethodsBridge;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/aspectratioutil/intf/NineSixteenLayoutConfig;
    ...
    const-class v0, Landroidx/appcompat/widget/FitWindowsLinearLayout;

    const-class v0, Landroidx/appcompat/widget/ViewStubCompat;

    const-class v0, Landroidx/appcompat/widget/ContentFrameLayout;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/component/ToastingBadge;

    const-class v0, LX/2gm;

    const-class v0, Lcom/instagram/ui/widget/proxy/ProxyFrameLayout;
    ...
    const-class v0, Lcom/instagram/common/ui/widget/imageview/CircularImageView;
    ...
    const-class v0, Lcom/facebook/rendercore/MountItemsPool$PoolsActivityCallback;

    const-class v0, Lcom/instagram/igds/components/shimmer/placeholder/SimpleShimmerPlaceholderView;
    ...
    const-class v0, Lcom/instagram/model/hashtag/HashtagFollowStatus;
    ...
    const-class v0, Lcom/facebook/privacy/zone/upf/PurposePolicy;

    const-class v0, LX/2hy;

    const-class v0, LX/2hz;

    const-class v0, Lcom/facebook/privacy/zone/api/ZonedValue;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/HeroScrollSetting;
    ...
    const-class v0, Lcom/instagram/unifiedfeedback/disclosure/UnifiedFeedbackDisclosureApi;
    ...
    const-class v0, Lcom/instagram/common/ui/widget/imageview/ConstrainedImageView;
    ...
    const-class v0, Lcom/instagram/arp/api/AvatarProfilePictureApiController;
    ...
    const-class v0, Lcom/instagram/common/pictureinpicture/PictureInPictureBackdrop;
    ...
    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$7;
    ...
    const-class v0, Lcom/instagram/actionbar/ActionBarTitleViewSwitcher;
    ...
    const-class v0, Lcom/instagram/igds/components/snackbar/IgdsSnackBar;

    const-class v0, Landroidx/constraintlayout/widget/Barrier;

    const-class v0, Lcom/instagram/igds/components/snackbar/IgdsUploadSnackBar;
    ...
    const-class v0, Lcom/instagram/reels/ui/views/reelavatar/RecyclerReelAvatarView;

    const-class v0, Lcom/instagram/ui/widget/gradientspinner/GradientSpinner;
    ...
    const-class v0, Lcom/facebook/location/appstate/GeoApiLocationAppStateListener$LifecycleCallback;
    ...
    const-class v0, LX/2lV;

    const-class v0, LX/2lW;
    ...
    const-class v0, Lcom/instagram/feed/media/EffectActionSheet;
    ...
    const-class v0, Lcom/instagram/feed/widget/IgProgressImageView;

    const-class v0, Lcom/instagram/feed/widget/IgProgressImageViewProgressBar;

    const-class v0, Lcom/instagram/tagging/widget/TagsLayout;
    ...
    const-class v0, Lcom/instagram/feed/ui/text/IgLikeTextView;

    const-class v0, Lcom/instagram/feed/ui/text/BulletAwareTextView;
    ...
    const-class v0, Lcom/instagram/ui/widget/textview/IgTextLayoutView;

    const-class v0, LX/2nP;

    const-class v0, Lcom/instagram/realtimeclient/GraphQLSubscriptionHandler;
    ...
    const-class v0, Lcom/instagram/video/player/hero/IgHttpConnectionForProxy;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/VideoPlayContextualSetting;
    ...
    const-class v0, Lcom/google/android/gms/internal/common/zzb;
    ...
    const-class v0, Lcom/facebook/push/fbns/ipc/FbnsAIDLRequest;

    const-class v0, Lcom/facebook/push/fbns/ipc/FbnsAIDLResult;

    const-class v0, Lcom/facebook/rti/mqtt/protocol/messages/SubscribeTopic;

    const-class v0, LX/0uf;

    const-class v0, LX/2oe;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeClientManager$7$1;
    ...
    const-class v0, Lcom/instagram/realtimeclient/bugreport/RealtimeLogsProvider$Companion$create$1;
    ...
    const-class v0, Lcom/instagram/realtimeclient/MainRealtimeEventHandler$1;
    ...
    const-class v0, Lcom/instagram/graphql/instagramschema/IGAvatarProfilePicInfoQueryResponsePandoImpl;
    ...
    const-class v0, Lcom/instagram/graphql/instagramschema/IGAvatarProfilePicInfoQueryResponsePandoImpl$XigAvatarProfilePictureInfo;
    ...
    const-class v0, Lcom/instagram/common/ui/blur/BlurUtil;

    const-class v0, Lcom/instagram/jni/igblur/IgBlur;
    ...
    const-class v0, Lcom/facebook/common/dextricks/DexStore$OptimizationHistoryLog;
    ...
    const-class v0, Lcom/facebook/mobileboost/framework/os/jni/MobileBoostNative;
    ...
    const-class v0, Lcom/facebook/tigon/tigonmns/TigonMNSConfig;
    ...
    const-class v0, Lcom/facebook/tigon/tigonmns/TigonMNSServiceHolder$TigonMNSUnexpectedErrorReporter;
    ...
    const-class v0, Lcom/facebook/secure/fileprovider/SecureFileProvider$Impl;
    ...
    const-class v0, Lcom/facebook/mobileconfig/factory/MobileConfigUpdateConfigsCallback;
    ...
    const-class v0, Lcom/instagram/realtimeclient/requeststream/IGRealtimeGraphQLObserverHolder$WWWIGRealtimeGraphQLObserverHolder;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/IGRealtimeGraphQLObserverHolder$1;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/WWWSubscribeExecutor;

    const-class v0, Lcom/instagram/realtimeclient/requeststream/WWWSubscribeExecutor$1;
    ...
    const-class v0, Lcom/instagram/ui/widget/roundedcornerlayout/RoundedCornerMediaFrameLayout;
    ...
    const-class v0, Lcom/instagram/igds/components/headline/IgdsHeadline;
    ...
    const-class v0, Lcom/instagram/igds/components/button/IgdsButton;
    ...
    const-class v0, Lcom/instagram/shopping/widget/pdp/cta/CustomCTAButton;

    const-class v0, LX/2zM;

    const-class v0, LX/2zN;

    const-class v0, Lcom/instagram/feed/adapter/row/RootConstraintLayout;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/AudioFocusLossSettings;

    const-class v0, LX/2zc;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/VideoPlayRequest;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/service/WarmUpPlayerListener;

    const-class v0, Lcom/facebook/video/heroplayer/service/HeroServicePlayerDummyListener;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/HeroServicePlayerListener;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/LiveState;

    const-class v0, LX/2zn;

    const-class v0, LX/2zo;

    const-class v0, Lcom/facebook/video/heroplayer/service/HeroServicePlayerCallback;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/HeroServicePlayerListener$Stub;
    ...
    const-class v0, LX/302;

    const-class v0, LX/303;

    const-class v0, LX/304;

    const-class v0, LX/305;

    const-class v0, LX/306;

    const-class v0, LX/307;

    const-class v0, LX/308;

    const-class v0, LX/309;

    const-class v0, LX/30A;

    const-class v0, LX/30B;
    ...
    const-class v0, LX/30N;

    const-class v0, LX/30O;

    const-class v0, LX/30P;

    const-class v0, LX/30Q;

    const-class v0, LX/30R;

    const-class v0, LX/30S;

    const-class v0, LX/30T;

    const-class v0, LX/30U;

    const-class v0, LX/30V;

    const-class v0, LX/30W;
    ...
    const-class v0, LX/310;

    const-class v0, Lcom/google/android/exoplayer2/metadata/Metadata;

    const-class v0, LX/312;

    const-class v0, LX/313;

    const-class v0, LX/314;

    const-class v0, LX/315;

    const-class v0, LX/316;

    const-class v0, LX/317;

    const-class v0, LX/318;

    const-class v0, LX/319;
    ...
    const-class v0, Lcom/google/android/exoplayer2/trackselection/DefaultTrackSelector$Parameters;
    ...
    const-class v0, LX/31O;

    const-class v0, LX/31P;

    const-class v0, LX/31Q;

    const-class v0, LX/31R;

    const-class v0, LX/31S;

    const-class v0, LX/31T;

    const-class v0, LX/31U;
    ...
    const-class v0, LX/321;

    const-class v0, LX/322;

    const-class v0, LX/323;

    const-class v0, LX/324;

    const-class v0, LX/325;

    const-class v0, LX/326;

    const-class v0, LX/327;

    const-class v0, LX/328;

    const-class v0, LX/329;
    ...
    const-class v0, LX/32N;

    const-class v0, LX/32O;

    const-class v0, LX/32P;

    const-class v0, LX/32Q;

    const-class v0, LX/32R;

    const-class v0, LX/32S;

    const-class v0, LX/32T;

    const-class v0, LX/32U;

    const-class v0, LX/32V;

    const-class v0, LX/32W;

    const-class v0, LX/32X;
    ...
    const-class v0, LX/330;

    const-class v0, LX/331;

    const-class v0, LX/332;

    const-class v0, LX/333;

    const-class v0, LX/334;

    const-class v0, LX/335;

    const-class v0, LX/336;

    const-class v0, LX/337;

    const-class v0, LX/338;

    const-class v0, LX/339;

    const-class v0, LX/33A;

    const-class v0, LX/33B;
    ...
    const-class v0, LX/33Q;

    const-class v0, LX/33R;

    const-class v0, LX/33S;

    const-class v0, LX/33T;

    const-class v0, LX/33U;

    const-class v0, LX/33V;

    const-class v0, LX/33W;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/ipc/ParcelableFormat;
    ...
    const-class v0, Lcom/facebook/video/heroplayer/client/HeroPlayer$HeroServicePlayerListenerImpl;

    const-class v0, LX/350;

    const-class v0, LX/351;

    const-class v0, LX/352;

    const-class v0, LX/353;

    const-class v0, LX/354;

    const-class v0, LX/355;

    const-class v0, LX/356;

    const-class v0, LX/357;

    const-class v0, LX/358;
    ...
    const-class v0, Lcom/instagram/ui/widget/textureview/ScalingTextureView;
    ...
    const-class v0, LX/365;

    const-class v0, LX/366;

    const-class v0, LX/367;

    const-class v0, LX/368;

    const-class v0, LX/369;
    ...
    const-class v0, LX/36M;

    const-class v0, LX/36N;

    const-class v0, LX/36O;

    const-class v0, LX/36P;
    ...
    const-class v0, LX/370;

    const-class v0, LX/371;

    const-class v0, LX/372;

    const-class v0, LX/373;

    const-class v0, LX/374;

    const-class v0, LX/375;

    const-class v0, LX/376;

    const-class v0, LX/377;
    ...
    const-class v0, Lcom/facebook/common/dextricks/DexErrorRecoveryInfoAsync;
    ...
    const-class v0, LX/388;

    const-class v0, LX/389;

    const-class v0, LX/38A;

    const-class v0, LX/0DN;
    ...
    const-class v0, LX/390;

    const-class v0, LX/391;

    const-class v0, LX/392;

    const-class v0, LX/393;

    const-class v0, LX/394;
    ...
    const-class v0, LX/398;

    const-class v0, LX/399;
    ...
    const-class v0, Landroidx/work/impl/WorkDatabase_Impl;
    ...
    const-class v0, Lcom/facebook/mobileboost/framework/os/jni/lite/MobileBoostNativeLite;
    ...
    const-class v0, Lcom/facebook/fixie/fixes/MediaCodecFixes/hooks/MediaCodecHooks$NativeImpl;

    const-class v0, Lcom/facebook/pando/PandoConsistencyServiceJNI;

    const-class v0, Lcom/facebook/pando/TreeJNI;

    const-class v0, Lcom/instagram/common/graphics/IgBitmapReferenceFactory;

    const-class v0, Lcom/instagram/debug/devoptions/debughead/config/DebugHeadConfigurations;

    const-class v0, Lcom/instagram/common/app/AbstractActivityLifecycleCallbacks;
    ...
    const-class v0, Lcom/facebook/tigon/iface/TigonSamplingPolicy;
    ...
    const-class v0, Lcom/google/common/collect/SingletonImmutableSet;
    ...
    const-class v0, Lcom/instagram/tagging/model/Tag;

    const-class v0, Lcom/instagram/debug/image/ImageDebugHelper;

    const-class v0, LX/3GN;

    const-class v0, Lcom/facebook/cameracore/ardelivery/xplatcache/ARDFileCache;

    const-class v0, Lcom/google/common/collect/ImmutableList;

    const-class v0, Lcom/google/common/collect/RegularImmutableList;

    const-class v0, Lcom/instagram/api/schemas/MediaOptionStyle;

    const-class v0, Lcom/google/common/collect/RegularImmutableMap$EntrySet;

    const-class v0, Lcom/google/common/collect/RegularImmutableMap$EntrySet$1;

    const-class v0, LX/0R2;

    const-class v0, Lcom/facebook/msys/mci/EventLogSubscriber;

    const-class v0, LX/09q;

    const-class v0, LX/0Zt;

    const-class v0, Lcom/instagram/debug/devoptions/apiperf/DebugHeadPlugin;
    ...
    const-class v0, Lcom/instagram/music/common/model/MusicDataSource;
    ...
    const-class v0, Lcom/instagram/tagging/widget/MediaTagHintsLayout;
    ...
    const-class v0, Lcom/instagram/common/analytics/intf/AnalyticsEventEntry;
    ...
    const-class v0, Lcom/facebook/profilo/provider/api/ExternalApiProvider;
    ...
    const-class v0, Lcom/facebook/profilo/provider/mappings/MemoryMappingsProvider;

    const-class v0, Lcom/facebook/profilo/provider/device_info/DeviceInfoProvider;

    const-class v0, Lcom/facebook/profilo/provider/aslsession/AslSessionIdProvider;

    const-class v0, Lcom/facebook/profilo/provider/memory/MemoryAllocationProvider;
    ...
    const-class v0, LX/3HR;

    const-class v0, LX/3HS;

    const-class v0, LX/09V;

    const-class v0, LX/3HT;

    const-class v0, LX/3HU;

    const-class v0, LX/3HV;
    ...
    const-class v0, Lcom/instagram/react/impl/IgReactPluginImpl;
    ...
    const-class v0, Landroidx/lifecycle/ProcessLifecycleOwner$3$1;

    const-class v0, LX/3I4;

    const-class v0, LX/3I5;

    const-class v0, Lcom/instagram/common/ui/base/IgFrameLayout;

    const-class v0, Lcom/instagram/common/ui/base/IgView;

    const-class v0, Lcom/instagram/common/ui/base/IgLinearLayout;

    const-class v0, Lcom/instagram/common/ui/base/IgSimpleImageView;

    const-class v0, Lcom/instagram/actionbar/ActionButton;

    const-class v0, Lcom/instagram/ui/widget/spinner/RefreshSpinner;

    const-class v0, Lcom/instagram/ui/widget/spinner/SpinnerImageView;

    const-class v0, Lcom/instagram/common/ui/colorfilter/ColorFilterAlphaImageView;

    const-class v0, Landroidx/core/view/accessibility/AccessibilityNodeInfoCompat;
    ...
    const-class v0, Lcom/instagram/ui/listview/StickyHeaderListView;

    const-class v0, LX/3IL;

    const-class v0, LX/3IM;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/L$ig_android_fleetbeacon_config$enable_distillery_fleet_beacon;

    const-class v0, LX/3IO;

    const-class v0, LX/3IP;

    const-class v0, LX/032;

    const-class v0, LX/02z;

    const-class v0, Lcom/instagram/igds/components/snackbar/IgdsDualButtonSnackBar;
    ...
    const-class v0, Lcom/facebook/profilo/config/ConfigParams;

    const-class v0, Lcom/facebook/profilo/mmapbuf/core/MmapBufferManager;

    const-class v0, Lcom/facebook/profilo/mmapbuf/core/Buffer;

    const-class v0, Lcom/facebook/profilo/writer/NativeTraceWriter;

    const-class v0, Lcom/facebook/profilo/logger/BufferLogger;

    const-class v0, Lcom/facebook/common/lyra/LyraManager;

    const-class v0, Lcom/facebook/breakpad/UnwindstackStreamManager;

    const-class v0, Lcom/facebook/fixie/fixes/common/TransactionTooLargeDebugger$1;
    ...
    const-class v0, Lcom/facebook/acra/anr/multisignal/MultiSignalANRDetector;

    const-class v0, Lcom/facebook/errorreporting/nightwatch/Nightwatch$NightwatchNative;

    const-class v0, Lcom/facebook/errorreporting/nightwatch/NightwatchOreo;
    ...
    const-class v0, Lcom/facebook/quicklog/MarkerEditor;

    const-class v0, Lcom/facebook/quicklog/reliability/UserFlowConfig$UserFlowConfigBuilder;

    const-class v0, Lcom/facebook/common/util/TriState;

    const-class v0, Lcom/facebook/quicklog/xplat/QPLXplatInitializerImpl;

    const-class v0, LX/0Q7;

    const-class v0, LX/0Kp;

    const-class v0, Lcom/facebook/quicklog/QuickPerformanceLoggerNativeProvider;
    ...
    const-class v0, Lcom/facebook/flexiblesampling/SamplingResult;
    ...
    const-class v0, Lcom/instagram/wellbeing/respectfulcommentnudge/data/RespectfulNudgeApi;
    ...
    const-class v0, Lcom/facebook/profilo/ipc/TraceConfigExtras;
    ...
    const-class v0, Lcom/google/common/collect/MapMakerInternalMap$Segment;

    const-class v0, Lcom/google/common/collect/MapMakerInternalMap$StrongKeyWeakValueSegment;
    ...
    const-class v0, Lcom/instagram/common/api/base/BandwidthEstimatorUtil;

    const-class v0, Lcom/instagram/fileregistry/OwnerHelper;

    const-class v0, Lcom/instagram/pendingmedia/model/ShareTargetHelper;
    ...
    const-class v0, Lcom/instagram/publisher/OperationHelper;

    const-class v0, Lcom/instagram/publisher/model/AttachmentHelper;

    const-class v0, Lcom/facebook/pando/NativeMap;

    const-class v0, Lcom/facebook/video/heroplayer/setting/FbAutogeneratedSettings;

    const-class v0, Lcom/facebook/distribgw/client/DGWClientConfig;

    const-class v0, Lcom/instagram/realtimeclient/MainRealtimeEventHandler$2;

    const-class v0, Lcom/facebook/pando/PandoGraphQLServiceJNI$NativeCallbacks;

    const-class v0, Lcom/instagram/userpay/api/UserPayApi;

    const-class v0, Lcom/instagram/common/typedurl/ImageCacheKey;

    const-class v0, Lcom/instagram/model/mediatype/ProductType;

    const-class v0, Lcom/facebook/video/heroplayer/ipc/ServicePlayerState;

    const-class v0, LX/3JB;

    const-class v0, Lcom/facebook/jni/NativeRunnable;

    const-class v0, Lcom/facebook/profilo/config/v2/ConfigParser;

    const-class v0, Lcom/facebook/profilo/logger/api/ProfiloLogger;

    const-class v0, Lcom/google/common/collect/ImmutableMap;

    const-class v0, Lcom/instagram/realtimeclient/bugreport/RealtimeLogsProvider$Companion;

    const-class v0, Lcom/instagram/debug/log/tags/DLogTag;

    const-class v0, Lcom/instagram/debug/log/DLog;

    const-class v0, Lcom/instagram/realtimeclient/clientconfig/RealtimeClientConfig;

    const-class v0, Lcom/instagram/realtimeclient/RealtimeStore;

    const-class v0, Lcom/facebook/mobilenetwork/DomainInfoUtils;

    const-class v0, Lcom/instagram/realtimeclient/fleetbeacon/FleetBeaconConfig;

    const-class v0, Lcom/instagram/realtimeclient/clientconfig/L$ig_android_realtime_subscription_log$sampling_weight;

    const-class v0, Lcom/instagram/realtimeclient/clientconfig/L$ig_android_realtime_subscription_log$is_gqls_debug_log_enabled;
    ...
    const-class v0, Lcom/instagram/api/schemas/BizUserInboxState;
    ...
    const-class v0, LX/3JR;

    const-class v0, LX/3JS;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape18S0201000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape0S0601000_I0;
    ...
    const-class v0, LX/3Jn;

    const-class v0, LX/3Jo;

    const-class v0, LX/3Jp;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape1S0200000_I1;
    ...
    const-class v0, LX/3K6;

    const-class v0, LX/3K7;

    const-class v0, LX/3K8;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape20S0000000_I1;

    const-class v0, LX/3KE;

    const-class v0, LX/3KF;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S1002000_I0;
    ...
    const-class v0, Lcom/instagram/clips/drafts/model/ClipsDraftPreviewItemRepository$2;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S1200000_I0;

    const-class v0, LX/3Kf;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0100000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0003000_I0;

    const-class v0, LX/3L5;

    const-class v0, LX/3L6;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0400000_I0;
    ...
    const-class v0, Lcom/facebook/redex/PCreatorCreatorShape0S0000000_I0;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape2S0201000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0010000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S1100000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S2010000_I0;

    const-class v0, LX/3LS;

    const-class v0, LX/3LT;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape6S0200000_I1_2;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0001100_I0;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape13S0201000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape5S0401000_I1;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape8S0201000_I0;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape3S0400000_I1;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0020000_I0;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S3010000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0121000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape15S0000000_I1_4;

    const-class v0, LX/3M3;

    const-class v0, LX/3M4;

    const-class v0, Lkotlin/jvm/internal/KtLambdaShape13S0000000_I1_2;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$map$2$2;
    ...
    const-class v0, Lcom/instagram/igds/debug/IgdsComponentOverlayInitializer$lifecycleCallbacks$1;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape15S0200000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0102000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape1S0900000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape5S0101000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape3S0311000_I1;

    const-class v0, Lkotlin/jvm/internal/KtLambdaShape5S0000000_I1;

    const-class v0, LX/3Ne;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S2500000_I0;

    const-class v0, Lcom/instagram/notifications/badging/impl/InMemoryBadgingRepository$getBadges$$inlined$map$1$2;

    const-class v0, LX/3Ng;

    const-class v0, LX/3Nh;

    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$map$4$2;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape9S0200000_I1;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$filter$2$2;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S3200000_I0;
    ...
    const-class v0, Lcom/instagram/mainactivity/bouncebacktoast/ui/BounceBackToastViewModel$special$$inlined$map$1$2;
    ...
    const-class v0, LX/3P3;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0500000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape2S0311000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S2200000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S3000000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S2300000_I0;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape4S0401000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape20S0201000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape6S0400000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape10S0300000_I0;

    const-class v0, LX/3Qe;

    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$filter$1$2;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S2000000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S6000000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape2S0601000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape3S0200000_I0;

    const-class v0, LX/3R4;
    ...
    const-class v0, LX/3R7;

    const-class v0, LX/3R8;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape0S0701000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape7S0301000_I1_1;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape0S0223000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape1S0401000_I0;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S5100000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape0S0411000_I0;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$map$3$2;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape14S0000000_I1_3;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape9S0201000_I1;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape1S0300000_I1;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape10S0000000_I0;
    ...
    const-class v0, Lcom/instagram/debug/network/DebugNetworkShapingConfigurationFactory;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/sundial/widget/CountdownDurationTogglePanavision;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape11S0200000_I1;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0200000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape4S0000000_I0_1;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S2002000_I0;

    const-class v0, LX/3Tk;

    const-class v0, LX/3Tl;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S1300000_I0;

    const-class v0, LX/3Tm;

    const-class v0, LX/3Tn;

    const-class v0, Lkotlin/jvm/internal/KtLambdaShape3S0000000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape4S0600000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape8S0200000_I0;

    const-class v0, LX/3U6;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0000100_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape0S0511000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape10S0200000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape4S0501000_I0;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$filterCombine$1$2;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape5S0301000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0101000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape1S0302000_I0;

    const-class v0, LX/3Uw;

    const-class v0, Lkotlin/jvm/internal/KtLambdaShape8S0300000_I0;

    const-class v0, LX/3Ux;

    const-class v0, LX/3Uy;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape1S0301000_I0;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$filterCombine$$inlined$map$1$2;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape13S0200000_I1_2;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S1500000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape0S0700000_I0;
    ...
    const-class v0, Lcom/facebook/redex/PCreatorCreatorShape1S0000000_I0_1;

    const-class v0, LX/1Du;

    const-class v0, LX/3Vc;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape0S0311000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape12S0201000_I1_3;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape8S0400000_I0;
    ...
    const-class v0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape0S0000000_I0;
    ...
    const-class v0, LX/3WR;

    const-class v0, LX/0bC;

    const-class v0, LX/3WS;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape18S0000000_I1_1;

    const-class v0, LX/3WV;

    const-class v0, LX/0u1;

    const-class v0, LX/0uI;

    const-class v0, LX/3WW;

    const-class v0, LX/3WX;

    const-class v0, LX/3WY;

    const-class v0, LX/3WZ;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0300000_I0;
    ...
    const-class v0, Lcom/facebook/redex/PCreatorCreatorShape2S0000000_I0_2;

    const-class v0, LX/3X5;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape9S0101000_I1_3;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape1S0501000_I0;

    const-class v0, LX/3XN;
    ...
    const-class v0, LX/3XW;

    const-class v0, LX/3XX;

    const-class v0, Lcom/instagram/notifications/badging/impl/InMemoryBadgingRepository$getBadges$$inlined$filter$1$2;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape17S0200000_I1_1;
    ...
    const-class v0, Lcom/instagram/notifications/badging/ui/viewmodel/BaseBadgeViewModel$special$$inlined$map$1$2;
    ...
    const-class v0, LX/3YO;

    const-class v0, LX/3YP;
    ...
    const-class v0, LX/3YU;

    const-class v0, LX/3YV;

    const-class v0, LX/3YW;
    ...
    const-class v0, Lcom/instagram/mainactivity/bouncebacktoast/ui/BounceBackToastViewModel$special$$inlined$mapNotNull$1$2;
    ...
    const-class v0, LX/04l;

    const-class v0, Lcom/facebook/fixie/fixes/memory/limitnativestack/LimitNativeStackSize;
    ...
    const-class v0, LX/3ZE;

    const-class v0, LX/3ZF;

    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S2100000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S0030000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape1S0201000_I0;

    const-class v0, LX/3ZQ;

    const-class v0, LX/3ZR;

    const-class v0, Lkotlin/coroutines/jvm/internal/KtCImplShape3S0301000_I1_1;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S1000000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S6100000_I0;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S1400000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape3S2200000_I0;
    ...
    const-class v0, Lcom/instagram/common/api/coroutine/ResultFlowExtensionsKt$mapSuccess$$inlined$map$2$2;
    ...
    const-class v0, Lcom/facebook/kotlin/compilerplugins/dataclassgenerate/superclass/KtCSuperShape0S3100000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape2S0400000_I0;
    ...
    const-class v0, Lkotlin/jvm/internal/KtLambdaShape16S0000000_I0;
    ...
    const-class v0, Lkotlin/coroutines/jvm/internal/KtSLambdaShape5S0300000_I0;
    ...
    const-class v0, Lcom/instagram/common/api/coroutine/ResultFlowExtensionsKt$mapError$$inlined$map$2$2;
