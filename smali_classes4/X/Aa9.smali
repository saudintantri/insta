...
# direct methods
.method public static A00(Landroid/content/Intent;LX/Bar;I)V
    .locals 5
    ...
    .line 4
    iget-object v4, v0, LX/BlX;->A00:Lcom/facebook/login/LoginClient$Request;
    ...
    .line 58
    .line 59
    invoke-direct {v1, v3, v2, v0}, LX/B94;-><init>(Lcom/facebook/AccessToken;Ljava/util/Set;Ljava/util/Set;)V

    .line 60
    .line 61
    .line 62
    iget-object v0, v1, LX/B94;->A01:Ljava/util/Set;
    ...
    .line 71
    .line 72
    invoke-interface {p1, v1}, LX/Bar;->onSuccess(Ljava/lang/Object;)V
    ...
    .line 78
    :cond_2
    invoke-interface {p1}, LX/Bar;->onCancel()V
    ...
    .line 88
    :cond_5
    invoke-interface {p1, v0}, LX/Bar;->onError(Ljava/lang/String;)V
