...
.method private initRecording(IIZZZ)I
    ...
    :goto_1
    :try_start_0
    sget v5, Lorg/webrtc/voiceengine/WebRtcAudioRecord;->audioSource:I
    ...
    .line 97
    invoke-static/range {v5 .. v10}, Lorg/webrtc/voiceengine/WebRtcAudioRecord;->createAudioRecordOnMOrHigher(IIIIIZ)Landroid/media/AudioRecord;
    ...
    .line 105
    .line 106
    invoke-static {v0, p1, v7, v8, v9}, Lorg/webrtc/voiceengine/WebRtcAudioRecord;->createAudioRecordOnLowerThanM(IIIII)Landroid/media/AudioRecord;
